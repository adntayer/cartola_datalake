# uv run -m cartola_datalake.mesh.01_source_to_landing.pontuados
import os
...
def main(rodada):
    ...
    if list_jsons:
        ...
        for file_json in list_jsons:
            _hash = calculate_dict_checksum(load_dict_from_file_compress(os.path.join(path_dir, file_json)))
